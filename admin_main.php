        ...
        <td><table width="960" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="719" valign="top"><table width="719" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="7" align="left"><img src="images/top-left.jpg" width="7" height="45" /></td>
                <td width="707" align="left" background="images/top2.jpg" class="textWhiteBold"><!-- InstanceBeginEditable name="EditRegion3" --><img src="images/save_icon.png" border="0" align="absmiddle" /> จัดการข้อมูลพื้นฐาน<!-- InstanceEndEditable --></td>
                <td width="7" align="right"><img src="images/top-right.jpg" width="8" height="45" /></td>
              </tr>
              <tr>
                <td background="images/left.jpg">&nbsp;</td>
                <td align="left"><!-- InstanceBeginEditable name="EditRegion4" -->
                  <table width="704" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                      <td width="304" align="left"><img src="images/setting.png" width="25" height="25" border="0" align="absmiddle" /> <a href="user.php" id="k2">จัดการข้อมูลผู้ใช้งาน</a></td>
                      <td width="380" align="left"><img src="images/setting.png" width="25" height="25" border="0" align="absmiddle" /> <a href="year_budget.php" id="k2">จัดการข้อมูลปีงบประมาณ</a></td>
                    </tr>
                    <tr>
                      <td><img src="images/setting.png" width="25" height="25" border="0" align="absmiddle" /> <a href="strategic_province.php" id="k2">จัดการข้อมูลประเด็นยุทธศาสตร์จังหวัด</a></td>
                      <td><img src="images/setting.png" width="25" height="25" border="0" align="absmiddle" /> <a href="strategic_district.php" id="k2">จัดการข้อมูลประเด็นยุทธศาสตร์อำเภอ</a></td>
                    </tr>
                    <tr>
                      <td><img src="images/setting.png" width="25" height="25" border="0" align="absmiddle" /> <a href="strategic_hospital.php" id="k2">จัดการข้อมูลประเด็นยุทธศาสตร์โรงพยาบาล</a></td>
                      <td><img src="images/setting.png" width="25" height="25" border="0" align="absmiddle" /> <a href="responsibility.php" id="k2">จัดการข้อมูลพันธกิจ</a></td>
                    </tr>
                    <tr>
                      <td><img src="images/setting.png" width="25" height="25" border="0" align="absmiddle" /> <a href="target.php" id="k2">จัดการข้อมูลเป้าประสงค์</a></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
