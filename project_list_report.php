        ...
        <td><table width="960" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="719" valign="top"><table width="719" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="7" align="left"><img src="images/top-left.jpg" width="7" height="45" /></td>
                <td width="707" align="left" background="images/top2.jpg" class="textWhiteBold"><!-- InstanceBeginEditable name="EditRegion3" --><img src="images/list.png" border="0" align="absmiddle" /> รายการข้อมูลโครงการ<!-- InstanceEndEditable --></td>
                <td width="7" align="right"><img src="images/top-right.jpg" width="8" height="45" /></td>
              </tr>
              <tr>
                <td background="images/left.jpg">&nbsp;</td>
                    ...
                    <tr>
                      <td><table width="704" border="0" cellspacing="0" cellpadding="0">
                        <tr class="textBlackBold">
                          <td width="41" height="25" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">ลำดับ</td>
                          <td width="258" height="25" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">ชื่อโครงการ</td>
                          <td width="139" height="25" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">หน่วยงานรับผิดชอบ</td>
                          <td width="97" height="25" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">จำนวนเงิน</td>
                          <td width="56" height="25" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">สถานะ</td>
                          <td height="25" colspan="2" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">พิมพ์</td>
                          </tr>
                        <?php
                        ...
                        <tr class="textBlackNormal" onmouseover="this.style.backgroundColor='#E3FFBB'" onmouseout="this.style.backgroundColor=''">
						  ...
						  ?></td>
                          <td width="62" height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><a href="project_detail_form.php?project_id=<?php echo $rp['project_id']; ?>" target="_blank" id="k2">แบบฟอร์ม</a></td>
                          <td width="51" height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;"><a href="project_detail.php?project_id=<?php echo $rp['project_id']; ?>" target="_blank" id="k2">สรุปผล</a></td>
                          </tr>
                        <?php } //end while ?>
                      </table></td>
                    </tr>
