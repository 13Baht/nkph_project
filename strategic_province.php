        ...
        <td><table width="960" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="719" valign="top"><table width="719" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="7" align="left"><img src="images/top-left.jpg" width="7" height="45" /></td>
                <td width="707" align="left" background="images/top2.jpg" class="textWhiteBold"><!-- InstanceBeginEditable name="EditRegion3" -->จัดการข้อมูลประเด็นยุทธศาสตร์จังหวัด<!-- InstanceEndEditable --></td>
                <td width="7" align="right"><img src="images/top-right.jpg" width="8" height="45" /></td>
              </tr>
              <tr>
                <td background="images/left.jpg">&nbsp;</td>
...
function q1(v) {
	var url = "strategic_province_list.php?year_budget=" + v;
	LoadData(url, "t1");
}
function popupAdd(st, strategic_province_id) {
	var str = Math.random();
	w = screen.availWidth;
	h = screen.availHeight;
	var popW = 550, popH = 400;
	var leftPos = (w-popW)/2, topPos = (h-popH)/2;
	window.open("popup_strategic_province_add.php?st=" + st + "&strategic_province_id=" + strategic_province_id, "loadorder", "width=" + popW + ", height=" + popH + ", top=" + topPos + ", left=" + leftPos + ", menubar=no, resizeable=no, toolbar=no, scrollbars=yes");
}
</script>
                      ...
                      <td width="29%" align="right"><img src="images/add.png" width="21" height="21" border="0" align="absmiddle" /><a href="javascript:;" onclick="popupAdd('save', '')" id="k2">เพิ่มประเด็นยุทธศาสตร์จังหวัด</a></td>
                    </tr>
                    <tr>
