...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr class="textBlackNormal">
                                  ...
                                  <td width="56%" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">ชื่อประเด็นยุทธศาสตร์อำเภอ</td>
                                  ...
                                  <?php
								  $sql = "select sd.*, ss.status_name from strategic_district sd left outer join s_status ss on sd.strategic_district_status = ss.status_id where sd.strategic_district_year = '$year_budget' order by sd.strategic_district_id";
								  $result = mysql_db_query($db, $sql);
								  $i = 1;
								  while ($r = mysql_fetch_array($result)) {
									  $c = "";
									  if ($r['strategic_district_status'] == "0") {
										  $c = "textRedSmall";
									  }
								  ?>
                                <tr class="textBlackNormal" onmouseover=this.style.backgroundColor="#E3FFBB" onmouseout=this.style.backgroundColor="">
                                  ...
                                  <td height="25" align="left" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo $r['strategic_district_name']; ?></td>
                                  <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo $r['strategic_district_year']; ?></td>
                                  ...
                                  <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;"><a href="javascript:;" onclick="popupAdd('edit', '<?php echo $r['strategic_district_id']; ?>')"><img src="images/edit.png" width="22" height="22" border="0" align="absmiddle" /></a></td>
                                  </tr>
                                  <?php } //end while ?>
                                </table>