...
<title>เพิ่มตัวชี้วัดผลลัพธ์</title>
<link rel="stylesheet" type="text/css" href="css/mycss-popup.css"/>
<script src="js/myjs.js"></script>
<script>
function OnOK(){
	eval("self.opener.getOKPointResult()");
	window.close();	
}
function saveData() {
	...
	var url = "point_result_save.php?project_id=" + encodeURIComponent(project_id) + "&point_result=" + encodeURIComponent(point_result) + "&point_result_unit=" + encodeURIComponent(point_result_unit) + "&point_result_target=" + point_result_target + "&st=save";
	LoadData(url, "tSave");
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" colspan="2" align="center" bgcolor="#E9E9E9" class="textBlackBold" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC; border-right:1px solid #CCC;">เพิ่มตัวชี้วัดผลลัพธ์</td>
  </tr>
  <tr>
