        ...
        <td><table width="960" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="719" valign="top"><table width="719" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="7" align="left"><img src="images/top-left.jpg" width="7" height="45" /></td>
                <td width="707" align="left" background="images/top2.jpg" class="textWhiteBold"><!-- InstanceBeginEditable name="EditRegion3" -->จัดการข้อมูลเป้าประสงค์<!-- InstanceEndEditable --></td>
                <td width="7" align="right"><img src="images/top-right.jpg" width="8" height="45" /></td>
              </tr>
              <tr>
                <td background="images/left.jpg">&nbsp;</td>
...
function q1(v1, v2) {
	var url4 = 'q_responsibility.php?year_budget_id=' + v1;
	LoadData(url4, "t2");
	var url = "target_list.php?year_budget=" + v1;
	LoadData(url, "t1");
}
function qTarget(v2) {
	var v1 = document.form1.year_budget_id.value;
	var url = "target_list.php?year_budget=" + v1 + "&responsibility_id=" + v2;
	LoadData(url, "t1");
}
function popupAdd(st, target_id) {
	var str = Math.random();
	w = screen.availWidth;
	h = screen.availHeight;
	var popW = 550, popH = 400;
	var leftPos = (w-popW)/2, topPos = (h-popH)/2;
	window.open("popup_target_add.php?st=" + st + "&target_id=" + target_id, "loadorder", "width=" + popW + ", height=" + popH + ", top=" + topPos + ", left=" + leftPos + ", menubar=no, resizeable=no, toolbar=no, scrollbars=yes");
}
</script>
                      <form id="form1" name="form1" method="post" action="">
                        <span class="textBlackNormal">ปีงบประมาณ :</span>
<select name="year_budget_id" id="year_budget_id" style="width:90px;" onchange="q1(this.value, '')">
  ...
  <?php
                      ...
                      &nbsp;&nbsp;<span class="textBlackNormal">พันธกิจ :</span> <span id="t2">&nbsp;</span></form></td>
                      <td width="20%" align="right"><img src="images/add.png" width="21" height="21" border="0" align="absmiddle" /><a href="javascript:;" onclick="popupAdd('save', '')" id="k2">เพิ่มข้อมูลพันธกิจ</a></td>
                    </tr>
                    <tr>
