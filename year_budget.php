        ...
        <td><table width="960" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="719" valign="top"><table width="719" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="7" align="left"><img src="images/top-left.jpg" width="7" height="45" /></td>
                <td width="707" align="left" background="images/top2.jpg" class="textWhiteBold"><!-- InstanceBeginEditable name="EditRegion3" -->จัดการข้อมูลปีงบประมาณ<!-- InstanceEndEditable --></td>
                <td width="7" align="right"><img src="images/top-right.jpg" width="8" height="45" /></td>
              </tr>
              <tr>
                <td background="images/left.jpg">&nbsp;</td>
                <td align="left"><!-- InstanceBeginEditable name="EditRegion4" --><table width="704" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="25" align="left">
                      <script>
					  function chkSave() {
						  if (document.frm1.year_budget_id.value == "") {
							  alert('กรุณากรอกปีงบประมาณที่ต้องการเพิ่ม');
							  document.frm1.year_budget_id.focus();
							  return false;
						  }
                      ...
                      <form id="frm1" name="frm1" method="post" action="year_budget_save.php" onsubmit="return chkSave()">
                        <p class="textBlackNormal">เพิ่มปีงบประมาณ
                          <input name="year_budget_id" type="text" id="year_budget_id" size="5" maxlength="4" />
                            ...
                            <tr>
                              <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr class="textBlackNormal">
                                  ...
                                  <td width="82%" height="25" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">ปีงบประมาณ</td>
                                  <td width="10%" height="25" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC; border-right:1px solid #CCC;">ลบ</td>
                                  </tr>
                                  <?php
								  $sql_y = "select * from year_budget order by year_budget_id desc";
								  $result_y = mysql_db_query($db, $sql_y);
								  $i = 1;
								  while ($r_y = mysql_fetch_array($result_y)) {
								  ?>
                                <tr class="textBlackNormal">
                                  <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo $i++; ?></td>
                                  <td height="25" align="left" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo $r_y['year_budget_id']; ?></td>
                                  <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;"><a href="year_budget_save.php?year_budget_id=<?php echo $r_y['year_budget_id']; ?>&st=del" onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่')"><img src="images/del.gif" width="24" height="24" border="0" /></a></td>
                                  </tr>
                                  <?php } //end while ?>
                                </table></td>
                            </tr>
