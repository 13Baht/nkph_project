        ...
        <td><table width="960" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="719" valign="top"><table width="719" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="7" align="left"><img src="images/top-left.jpg" width="7" height="45" /></td>
                <td width="707" align="left" background="images/top2.jpg" class="textWhiteBold"><!-- InstanceBeginEditable name="EditRegion3" --><img src="images/home.png" border="0" align="absmiddle" /> หน้าแรก<!-- InstanceEndEditable --></td>
                <td width="7" align="right"><img src="images/top-right.jpg" width="8" height="45" /></td>
              </tr>
              <tr>
                <td background="images/left.jpg">&nbsp;</td>
                <td align="left"><!-- InstanceBeginEditable name="EditRegion4" -->
                  <table width="704" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" class="textBlackNormal">
<?php
$sqly = "select year_budget_id from year_budget order by year_budget_id desc limit 1";
$resulty = mysql_query($sqly);
$ry = mysql_fetch_row($resulty);
?>
...
function Load1(year_budget) {
	var url = "project_result1.php?year_budget=" + year_budget;
	LoadData(url, "tData1");
}
</script>
                      <form id="form1" name="form1" method="post" action="">
                        ปีงบประมาณ
                      <select name="year_budget_id" id="year_budget_id" style="width:90px;" onchange="Load1(this.value)">
                        <?php
