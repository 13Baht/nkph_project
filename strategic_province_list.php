...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr class="textBlackNormal">
                                  ...
                                  <td width="56%" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">ชื่อประเด็นยุทธศาสตร์จังหวัด</td>
                                  ...
                                  <?php
								  $sql = "select sp.*, ss.status_name from strategic_province sp left outer join s_status ss on sp.strategic_province_status = ss.status_id where sp.strategic_province_year = '$year_budget' order by sp.strategic_province_id";
								  $result = mysql_db_query($db, $sql);
								  $i = 1;
								  while ($r = mysql_fetch_array($result)) {
									  $c = "";
									  if ($r['strategic_province_status'] == "0") {
										  $c = "textRedSmall";
									  }
								  ?>
                                <tr class="textBlackNormal" onmouseover=this.style.backgroundColor="#E3FFBB" onmouseout=this.style.backgroundColor="">
                                  ...
                                  <td height="25" align="left" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo $r['strategic_province_name']; ?></td>
                                  <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo $r['strategic_province_year']; ?></td>
                                  ...
                                  <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;"><a href="javascript:;" onclick="popupAdd('edit', '<?php echo $r['strategic_province_id']; ?>')"><img src="images/edit.png" width="22" height="22" border="0" align="absmiddle" /></a></td>
                                  </tr>
                                  <?php } //end while ?>
                                </table>