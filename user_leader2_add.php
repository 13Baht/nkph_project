        ...
        <td><table width="960" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td width="719" valign="top"><table width="719" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="7" align="left"><img src="images/top-left.jpg" width="7" height="45" /></td>
                <td width="707" align="left" background="images/top2.jpg" class="textWhiteBold"><!-- InstanceBeginEditable name="EditRegion3" -->จัดการข้อมูลรองผู้อำนวยการ<!-- InstanceEndEditable --></td>
                <td width="7" align="right"><img src="images/top-right.jpg" width="8" height="45" /></td>
              </tr>
              <tr>
                <td background="images/left.jpg">&nbsp;</td>
...
function popupsearchLeader2(module, output1, output2) {
	var str = Math.random();
	w = screen.availWidth;
	...
	window.open("popup_person.php?module=" + module + "&output1=" + output1 + "&output2=" + output2 + "&str=" + str, "loadorder", "width=" + popW + ", height=" + popH + ", top=" + topPos + ", left=" + leftPos + ", menubar=no, resizeable=no, toolbar=no, scrollbars=yes");
                  ...
                  <form method="post" action="user_leader2_save.php" name="frm1" onsubmit="return chkData()">
                  <table width="670" border="0" cellspacing="0" cellpadding="0">
                    <?php if ($st == "save") { ?>
                    <tr>
                      <td width="99" height="25" align="left" class="textBlackNormal">ชื่อ - สกุล :</td>
                      <td width="571" height="25" align="left">
                      <input name="leader2_name" type="text" id="leader2_name" readonly="readonly" style="width:200px;" />
                      <a href="javascript:;" onClick="popupsearchLeader2('frm1', 'document.frm1.leader2_name', 'document.frm1.leader2_id')" title="คลิกเพื่อค้นหารายชื่อ"><img src="images/detail.png" width="23" height="23" border="0" align="absmiddle" /></a>
                      </td>
                    </tr>
                    <?php } //end save ?>
                    <?php if ($st == "edit") { ?>
			...
			function check_uncheck_all(checkname, field) {
			  ...
			  while ($r_sd = mysql_fetch_array($result_sd)) {
				  if ($st == "edit") {
					  $sqlng = "select sub_dept_id from user_leader2_detail where person_id = '$person_id' and sub_dept_id = '$r_sd[sub_dept_id]'";
                ...
                $i++;
                    ...
                    <tr>
                      ...
                      <td height="25" align="left"><input type="submit" name="button2" id="button2" value="  บันทึก  " />
                        <input type="hidden" name="st" id="st" value="<?php echo $st; ?>" /><input name="leader2_id" type="hidden" id="leader2_id" value="<?php echo $person_id; ?>" /></td>
                    </tr>
                  </table>
                  </form>
