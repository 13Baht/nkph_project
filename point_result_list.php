...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="54%" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">รายการตัวชี้วัดผลลัพธ์</td>
                                  ...
                                  <?php
								  $sql_cm = "select * from tb_project_point_result where project_id = \"$project_id\" order by point_result_id";
                                  ...
                                  <tr>
                                    ...
                                    <td height="25" align="left" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo nl2br($r_cm['point_result']); ?></td>
                                    ...
                                    <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;"><a href="javascript:;" onclick="delPointResult('<?php echo $r_cm['point_result_id']; ?>')" title="ลบ"><img src="images/bin.png" border="0" align="absmiddle" /></a></td>
                                  </tr>
                                  <?php } //end while ?>
                                </table>