...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" align="left" class="textBlackBold">โครงการแยกตามประเด็นยุทธศาสตร์พัฒนาสุขภาพอำเภอ ปีงบประมาณ <?php echo $year_budget; ?></td>
  </tr>
  <tr>
    <td height="25" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <?php
	  //ยุทธศาสตร์อำเภอ
	  $sql_strategic_district = "select sd.strategic_district_id, sd.strategic_district_name, sum(tp.project_money) sum_money_strategic_district
from strategic_district sd
left outer join tb_project tp on sd.strategic_district_id = tp.strategic_district_id
where sd.strategic_district_year = '$year_budget' and sd.strategic_district_status = '1'
group by sd.strategic_district_id";
	  $result_strategic_district = mysql_query($sql_strategic_district);
	  while ($r_strategic_district = mysql_fetch_array($result_strategic_district)) {
...
where tp.strategic_district_id = '$r_strategic_district[strategic_district_id]'";
		  $result_sum_pay_strategic = mysql_query($sql_sum_pay_strategic);
		  $r_sum_pay_strategic = mysql_fetch_row($result_sum_pay_strategic);
		  $money_result_strategic = $r_strategic_district['sum_money_strategic_district'] - $r_sum_pay_strategic[0];
	  ?>
      <tr>
        <td height="25" bgcolor="#EBFFCC" class="textBlackBold" style="border-left:1px solid #CCC; border-bottom:1px solid #CCC; border-right:1px solid #CCC;"><?php echo $r_strategic_district['strategic_district_name']; ?></td>
        <td height="25" align="center" bgcolor="#EBFFCC" style="border-bottom:1px solid #CCC; border-right:1px solid #CCC;">&nbsp;</td>
        <td height="25" align="right" bgcolor="#EBFFCC" class="textBlackBold" style="border-bottom:1px solid #CCC; border-right:1px solid #CCC;"><?php echo number_format($r_strategic_district['sum_money_strategic_district'], 2); ?></td>
