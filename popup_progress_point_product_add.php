...
<title>เพิ่มความก้าวหน้าตามตัวชี้วัดผลผลิต</title>
...
function saveData() {
	...
	var url = "progress_point_product_save.php?project_id=" + encodeURIComponent(project_id) + "&point_product=" + encodeURIComponent(point_product) + "&point_product_unit=" + encodeURIComponent(point_product_unit) + "&point_product_target=" + point_product_target + "&result=" + result + "&st=save";
	LoadData(url, "tSave");
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" colspan="2" align="center" bgcolor="#E9E9E9" class="textBlackBold" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC; border-right:1px solid #CCC;">เพิ่มความก้าวหน้าตามตัวชี้วัดผลผลิต</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        ...
        <td width="73%" height="25" align="left"><input name="point_product" type="text" id="point_product" style="width:300px;" maxlength="255" /></td>
      </tr>
      <tr>
        <td height="25" align="left">หน่วยนับ :</td>
        <td height="25" align="left"><input name="point_product_unit" type="text" id="point_product_unit" style="width:100px;" maxlength="20" /></td>
      </tr>
      <tr>
        <td height="25" align="left">เป้าหมาย :</td>
        <td height="25" align="left"><input name="point_product_target" type="text" id="point_product_target" style="width:100px;" maxlength="10" /></td>
      </tr>
      <tr>
