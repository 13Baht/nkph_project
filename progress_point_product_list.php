...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="41%" align="center" bgcolor="#E9E9E9" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-top:1px solid #CCC;">ตัวชี้วัดผลผลิต</td>
                                  ...
                                  <?php
								  $sql_cm = "select * from tb_project_point_product_progress where project_id = \"$project_id\" order by point_product_id";
                                  ...
                                  <tr>
                                    ...
                                    <td height="25" align="left" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><?php echo $r_cm['point_product']; ?></td>
                                    ...
                                    <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC;"><a href="javascript:;" onclick="editPointProductProgress('<?php echo $r_cm['point_product_id']; ?>')"><img src="images/edit.png" width="22" height="22" border="0" /></a></td>
                                    <td height="25" align="center" style="border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;"><a href="javascript:;" onclick="delPointProductProgress('<?php echo $r_cm['point_product_id']; ?>')" title="ลบ"><img src="images/bin.png" border="0" align="absmiddle" /></a></td>
                                  </tr>
